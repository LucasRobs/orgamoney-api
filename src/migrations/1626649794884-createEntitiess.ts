...
export class createEntitiess1626649794884 implements MigrationInterface {
    name = 'createEntitiess1626649794884'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "income" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "value" double precision NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "monthId" uuid, "categoryId" integer, CONSTRAINT "REL_977569f13a51a1ec583765daff" UNIQUE ("categoryId"), CONSTRAINT "PK_29a10f17b97568f70cee8586d58" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bill" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "value" double precision NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "monthId" uuid, "categoryId" integer, CONSTRAINT "REL_ddb6e5c07f27ceae2925e1fec2" UNIQUE ("categoryId"), CONSTRAINT "PK_683b47912b8b30fe71d1fa22199" PRIMARY KEY ("id"))`);
